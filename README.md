...
![Tests](https://img.shields.io/badge/tests-1142%20backend%20%2B%20432%20frontend-brightgreen)
![Status](https://img.shields.io/badge/release-v2.31.5%20(SRS%20v2.31.5)-success)
...
- **[System Requirements Specification](docs/superpowers/specs/2026-05-17-paperhub-srs.md)** — authoritative architecture, schema, scope, and acceptance criteria (shipped through **v2.31.5**).
