...
![Tests](https://img.shields.io/badge/tests-1134%20backend%20%2B%20426%20frontend-brightgreen)
...
- **[System Requirements Specification](docs/superpowers/specs/2026-05-17-paperhub-srs.md)** — authoritative architecture, schema, scope, and acceptance criteria (shipped through **v2.31.2**).
