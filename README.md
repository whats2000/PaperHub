...
![Tests](https://img.shields.io/badge/tests-1005%20backend%20%2B%20349%20frontend-brightgreen)
![Status](https://img.shields.io/badge/Plan%20F-merged%20(SRS%20v2.27.2)-success)
...
- **[System Requirements Specification](docs/superpowers/specs/2026-05-17-paperhub-srs.md)** — authoritative architecture, schema, scope, and acceptance criteria (currently **v2.27.2**).
