...
export function CitationCanvas() {
  ...
  //      highlight in the onLoad handler below.
  //   B) Same-paper navigation: the iframe src stays the same → onLoad does
  //      NOT re-fire. We detect this here by checking readyState === "complete"
  //      and calling findAndHighlight directly.
  //
