...
| F — Slide Pipeline + Report Agent | **Phase 1 in progress** (`feat/plan-F-slide-pipeline`) | [F1 — generation + viewing](docs/superpowers/plans/2026-05-23-paperhub-F1-slide-generation-viewing.md) · [F2 — presentation + editing](docs/superpowers/plans/2026-05-23-paperhub-F2-slide-presentation-editing.md) |
