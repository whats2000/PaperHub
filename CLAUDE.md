...
| F — Slide Pipeline + Report Agent | **F1 shipped; F2 shipped; F2.1 shipped; F3 shipped (PhD-grade slide agent); F4 code-complete (decoupling/editing — all gates green; real-API `:8000` sign-off pending); F5 pending (presentation/Q&A)** (`feat/plan-F-slide-pipeline`, SRS v2.21) | [F1 — generation + viewing](docs/superpowers/plans/2026-05-23-paperhub-F1-slide-generation-viewing.md) (shipped, generation internals superseded by F3) · F2 — Marker ingestion + PaperAsset (shipped) · [F2.1 — Marker as optional async add-on](docs/superpowers/plans/2026-05-24-paperhub-F2.1-async-marker-upgrade.md) (shipped) · **F3 — PhD-grade slide agent** (shipped, see topology below) · [**F4 — decoupled slide/notes generation + diff-editing**](docs/superpowers/plans/2026-05-25-paperhub-F4-slide-decoupling-editing.md) (planned, SRS v2.21) · [F5 — presentation + Q&A + version-history UI](docs/superpowers/plans/2026-05-23-paperhub-F4-slide-presentation-editing.md) (the old "F4 presentation+editing" doc; presentation/Q&A portion deferred) |
