...
| F — Slide Pipeline + Report Agent | **F1 shipped; F2 shipped; F2.1 designed; F3/F4 pending** (`feat/plan-F-slide-pipeline`, SRS v2.20) | [F1 — generation + viewing](docs/superpowers/plans/2026-05-23-paperhub-F1-slide-generation-viewing.md) (shipped, generation internals superseded by F3) · F2 — Marker ingestion + PaperAsset (shipped) · **[F2.1 — Marker as optional async add-on](docs/superpowers/plans/2026-05-24-paperhub-F2.1-async-marker-upgrade.md)** (next: PyMuPDF-fast ingest + durable background Marker upgrade) · **F3 — PhD-grade slide agent** · [F4 — presentation + editing](docs/superpowers/plans/2026-05-23-paperhub-F4-slide-presentation-editing.md) |
